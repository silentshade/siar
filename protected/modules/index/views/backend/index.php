...
<? $form = $this->beginWidget('bootstrap.widgets.TbActiveForm', array(
	...
	<?php echo $form->textFieldRow($model,'text',array('class'=>'span4','maxlength'=>255)); ?>


	<?php echo $form->textFieldRow($model,'name2',array('class'=>'span4','maxlength'=>255)); ?>

	<div class="control-group ">
		<label for="<?=$model->getModelName();?>_text2" class="control-label required">Текст 2 (справа) *</label>
		<div class="controls">
