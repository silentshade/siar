...
class MainController extends FrontController
{
	...
	{
		$page= SeoPages::model()->findByAttributes(array('module'=>'conferences'));
		...
		$criteria=new CDbCriteria(array(
			...
			'order'=>'t.begin_conf desc'
		));

		$pagination = new CPagination;
		$pagination->pageSize=Yii::app()->params['conferences_pagination'];
		$pagination->pageVar='page';

		$dataProvider=new CActiveDataProvider('Conferences',array(
			'criteria'=>$criteria,
	...
	{
		$model=Conferences::model()->findByPk($id);
