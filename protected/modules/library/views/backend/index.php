...
<?php $this->widget('MGridView',array(
	...
	'filter' => $model,
	'columns'=>array(
		array('name'=>'images','header'=>'<span style="font-size: smaller;">Обложка</span>','type'=>'raw','value'=>'"<img style=\'max-width:88px;\' src=\'/images/library/admin/".SiteHelper::returnOneImages($data->images)."?m=".$data->modified."\' />"','htmlOptions'=>array('style'=>'font-size: smaller;width:88px;max-width:88px;text-align:center;'),'filter'=>false),
		array(
			'name'=>'name',
			'header'=>'Название',
			'type'=>'raw',
