...
class ArticlesController extends CAdminController
{
	/**
	 * Creates a new model.
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Articles']))
		{
			...
			if(isset($_FILES['Articles']['name']['image']))
			foreach ($_FILES['Articles']['name']['image'] as $key=>$image) {
			...
			if ($model->save()) {
				 ...
				 * */
				$model->SaveImages();
				$this->redirect(array('articles/update?id='.$model->id));
			}
		}
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['Articles']))
		{
			...
			if(isset($_POST['Articles']['updatedimage']))
				SiteHelper::deleteImages($_POST['Articles']['updatedimage'],'/images/articles/');
...
//				echo '</pre>';
	...
	public function actionCopy($id)
	{
		...
		$this->redirect(array('articles/update?id='.$item->id));
	}
	/**
	...
	public function actionDelete($id)
	{
		...
		if(!isset($_GET['ajax']))
			$this->redirect(isset($_POST['returnUrl']) ? $_POST['returnUrl'] : '/admin/articles');
	}
	...
	public function actionImportXls(){
		if(is_uploaded_file($_FILES['file']["tmp_name"])){
			...
			foreach ($data as $value) {
				$find=Articles::model()->findByPk($value->id);
