...
function activateSearch() {
  ...
  if (asf) {
    ...
    aso.append('<img src="'+_base + 'cross.png" alt="close search" id="searchClose" onclick="closeSearch();" style="display:none" />');
    aso.append('<img src="'+_base + 'indicator.white.gif" alt="loading" id="indicator" style="display:none" />');
...
function doSearch() {
  ...
  $('#current-search-results').load('/search', pars).slideDown(600);
